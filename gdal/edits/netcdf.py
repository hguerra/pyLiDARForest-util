...
# https://github.com/NASA-DEVELOP/dnppy/blob/master/dnppy/convert/_extract_NetCDF_layer_data.py
...
if __name__ == "__main__":
    ...
    ncfile = r"E:\heitor.guerra\tests\jorge\pft50y_area.nc"
