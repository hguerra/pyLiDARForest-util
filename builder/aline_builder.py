...
def lines_zonal_stats_parcel(relation, vector, raster, log, nodata, vector_ext=".shp", raster_ext=".asc"):
    ...
    for info in relation:
        ...
        for r in info[raster]:
            lines.append(cmd.format(info[vector], r, nodata, ospath.join(log, ospath.basename(r) + ".log")))
    return lines
...
if __name__ == '__main__':
    ...
    relation_path = r"G:\Analise_HIPERESPECTRAL\Dados\shape_Hiper.csv"
    vector_path = r"G:\Analise_HIPERESPECTRAL\Dados\parcelas_campo\wgs"
    raster_path = r"G:\Analise_HIPERESPECTRAL\Dados\hiper\ivs_hiper"
    ...
    parcel = lines_zonal_stats_parcel(
        relation_path, vector_path,
        raster_path,
        log_path,
        raster_nodata_value,
