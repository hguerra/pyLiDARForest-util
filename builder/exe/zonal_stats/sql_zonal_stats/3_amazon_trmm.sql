-- DROP SEQUENCE public.amazon_trmm_new_seq;
CREATE SEQUENCE public.amazon_trmm_new_seq
INCREMENT 1
MINVALUE 1
MAXVALUE 9223372036854775807
START 1
CACHE 1;
ALTER TABLE public.amazon_trmm_new_seq
  OWNER TO eba;

-- Table: public.amazon_trmm_new

-- DROP TABLE public.amazon_trmm_new;
CREATE TABLE public.amazon_trmm_new
(
  fid         INTEGER NOT NULL DEFAULT nextval('amazon_trmm_new_seq' :: REGCLASS),
  "row"       INTEGER,
  col         INTEGER,
  states_id   INTEGER,
  mosaic_id   INTEGER,
  ...
  CONSTRAINT amazon_trmm_new_pkey PRIMARY KEY (fid),
  CONSTRAINT amazon_trmm_new_states_fkey FOREIGN KEY (states_id)
  REFERENCES public.states (gid) MATCH SIMPLE
  ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT amazon_trmm_new_mosaic_fkey FOREIGN KEY (mosaic_id)
...
ALTER TABLE public.amazon_trmm_new
  OWNER TO eba;
