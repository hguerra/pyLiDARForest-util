...
::%pgsql2shp% -f "E:\heitor.guerra\db_backup\rasters\random_forest\rf_train" -h localhost -u eba -P ebaeba18 eba "select amz.agblongo_tch_alive as train, st_centroid(amz.geom) as geom from amazon_palsar_17 as amz WHERE amz.agblongo_tch_alive is not null;"
